...
if __name__ == "__main__":
    ...
    plt.scatter(
        x_data[mask_0, 0].numpy(),
        x_data[mask_0, 1].numpy(),
        c="blue",
        label="Class 0",
        alpha=0.7,
        s=30,
    ...
    plt.scatter(
        x_data[mask_1, 0].numpy(),
        x_data[mask_1, 1].numpy(),
        c="red",
        label="Class 1",
        alpha=0.7,
        s=30,
    ...
    plt.scatter(
        x_data[pred_mask_0, 0].numpy(),
        x_data[pred_mask_0, 1].numpy(),
        c="blue",
        label="Pred Class 0",
        alpha=0.7,
        s=30,
    ...
    plt.scatter(
        x_data[pred_mask_1, 0].numpy(),
        x_data[pred_mask_1, 1].numpy(),
        c="red",
        label="Pred Class 1",
        alpha=0.7,
        s=30,
    ...
    # 用黑色空心圆标出预测错误的点
    plt.scatter(
        x_data[incorrect, 0].numpy(),
        x_data[incorrect, 1].numpy(),
        facecolors="none",
        edgecolors="black",
        linewidths=2,
        s=80,
    ...
    plt.suptitle(
        "Diabetes Classification: Ground Truth vs Model Prediction", fontsize=14
    )
    plt.tight_layout()
    plt.show()
