...
- **第6章**：训练技巧与优化，包括 Adam、Batch Normalization、正则化等
- **第7章**：卷积神经网络（CNN），包含 NumPy 版和 PyTorch 版实现
- **第8章**：深度卷积网络介绍，含 VGG16/VGG19 架构图解与原理分析
- **通用工具**：`common/` 目录包含梯度计算、卷积层、池化层、im2col 等通用函数
